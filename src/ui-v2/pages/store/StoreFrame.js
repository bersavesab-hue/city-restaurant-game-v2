...
function renderStoreFrame() {
  return (
    '<div class="ui-v2-store-frame" data-ui="store-frame" data-store-layout="empty">' +
      ...
      '<section class="ui-v2-store-frame__summary-wrap">' +
        '<header class="ui-v2-store-frame__section-head">' +
          '<div><span class="ui-v2-store-frame__section-icon" aria-hidden="true"></span><h2>门店经营概况</h2></div>' +
          '<button type="button" data-store-action="overview">经营详情</button>' +
        '</header>' +
